...
<head>
    <meta charset="UTF-8">
    <title>Pakalpojuma čeka apstiprinājums</title>
</head>
<body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; margin: 0; padding: 0;">
    <main style="max-width: 600px; margin: 0 auto; padding: 20px; background-color: #ffffff; border-radius: 8px; box-shadow: 0 2px 8px rgba(0,0,0,0.1);">
        ...
        <div style="padding: 20px;">
            ...
            <p style="color: #333;">Jūsu pakalpojuma pieteikums ir veiksmīgi apstrādāts. Šeit ir jūsu čeka informācija:</p>

            <h3 style="color: #ff9e1f; font-size: 18px; margin-bottom: 10px;">Pakalpojuma detaļas</h3>
            <ul style="padding-left: 20px; margin: 0; color: #333;">
                <li><strong>Nosaukums:</strong> {{ $service->name }}</li>
                <li><strong>Cena:</strong> €{{ number_format($service->price, 2) }}</li>
                <li><strong>Apraksts:</strong> {{ $service->description }}</li>
            </ul>
            ...
            <p style="color: #333;">Izmantojiet šo kodu, lai apskatītu savu čeku vai sazinātos ar mums.</p>
